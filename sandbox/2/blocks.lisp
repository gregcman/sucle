(defpackage #:mc-blocks
  (:export NAMES OPAQUECUBELOOUKUP LIGHTOPACITY CANBLOCKGRASS LIGHTVALUE
	   BLOCKINDEXINTEXTURE BLOCKHARDNESS BLOCKRESISTANCE BLOCKPARTICLEGRAVITY
	   SLIPPERINESS BLOCKNAME GETRENDERTYPE RENDERASNORMALBLOCK ISCOLLIDABLE)
  (:use #:cl))
...
(defun defblock (name id texture-index opaque?
  ...
  (macrolet ((put (attribute-name array)
    ...
    (put particle-gravity blockparticlegravity)))
