...
(progn
  ...
  (declaim (ftype (function ((simple-array t (*)) fixnum)
			    (or null (simple-array single-float (*)))) get-array-or-nil))
  (locally (declare (optimize (speed 3) (safety 0)))    
...
(progn
  (declaim (ftype (function (fixnum) (or t null)) get-scratch-float-array))
  (locally (declare (optimize (speed 3) (safety 0))
	...
	(if (< hashcode *scratch-float-array-size*)
	    (let ((array (get-array-or-nil *scratch-float-array* hashcode)))
		  ...
		  (let ((chunk-index (get-index n)))
		    (aref array chunk-index)))))))))


(progn
  (declaim (ftype (function (fixnum t)) set-scratch-float-array))
  (locally (declare (optimize (speed 3) (safety 0))
		    (inline get-index get-get-index get-array-or-nil))
